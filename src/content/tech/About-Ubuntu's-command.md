...
可以使用 [zashboard](https://github.com/Zephyruso/zashboard) 来作为 web 界面。

如果你需要 GUI，那么可以考虑 [clash-nyanpasu](https://github.com/LibNyanpasu/clash-nyanpasu)、[mihomo-party](https://github.com/mihomo-party-org/clash-party)我目前用的是这个
