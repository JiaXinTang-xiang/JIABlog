...
**TL;DR**：
本博客起初是想随便写一些教程，给个大概的学习方向，但在整理我过往收藏的资料和学习的视频发现，视觉需要学习多而杂，特别是进入Ubuntu后的学习，需要了解和学习的东西很多，因此考虑到后面实验室视觉的的发展，以及给将来的新生以及现在大一同学做一个全面的知识体系是非常有必要的。最近我看到他们刚安装好了虚拟机并且学习linux的一些命令，回想我安装好Ubuntu学习的时候，完全是摸着石头过河，东看一些西看一些，也是比较迷茫，不知道要学什么,非常的有感触。于是就有了这个我熬夜吐血整理的简单学习入门教程，里面记录视觉可以学习的入门内容，不是每个都要搞懂，主要是搭建学习框架，不至于不知道往哪个方向学习，里面有表述不清楚或者错误的地方，欢迎批评斧正。
...
下面是笔者推荐构建知识体系以及大学规划非常好的文章和资料，大家自行查看：
...
现在是2026年6月初，目前很多，便宜，好用，资料教程最多的是deepseek-v4-pro + claude code组合，可以在vscode上面使用，他能看到你整个工程文件和代码，向它提问可以帮你架构和debug，非常的方便，至于如何配置，大家自行根据关键字找到相关教程。

很多同学对AI的使用还停留在豆包这类工具的层面——把代码复制进去，让它帮忙 debug 或给些建议。或者对AI编程嗤之以鼻，不相信AI写出来的代码，甚至有些抵触或恐惧，毕竟AI编程看起来像个黑盒子，内部发生了什么完全看不清楚。对于AI编程，在我看来如今是一种趋势，AI已经非常强大，但是你能力的上限就决定了AI的上限，所以提升自己的能力是非常必要的。总的来说，AI是一种工具，它放大了你的能力，你可以作为一个架构师去架构你的项目，它也可以是老师，不会不懂的问题向她请教，最好提问完记录下来自己遇到的问题，便于总结，因此做笔记是非常重要的。这里关于如何使用AI，我不再过多赘述，仅仅表达我的看法，仁者见仁，智者见智吧。
...
对于类如这些视觉模块，不能只是跑官方的例程，想要学好，要去深入看官方封装好的库函数，了解常用库函数的内部结构原理，看懂，能知道怎么调用调试，以便根据题目跑出最大性能，因此能把这些视觉模块弄透也是非常好，非常厉害的，不必过度追求高性能开发板。
...
tips:我是看了OpenCV视频教程+《OpenCV4.0快速入门》后面时间紧张就去做项目，完全够了，大家也不要有看完全部再做项目，边做边学是最好的。
