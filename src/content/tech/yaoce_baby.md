...
在这里笔者推荐 [宋浩 ](https://space.bilibili.com/66607740) 的相关课程，对于线性代数这门可以理解为几乎最重要的数学课程，推荐读者观看 [3Blue1Brown ](https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab) 的相关讲解。这个系列课程通过大量直观有趣的可视化，给你提供直觉的理解。
数学基础，对于控制理论学习，非常重要的。

Markdown：记录你的笔记[Markdown 语法 ](https://www.markdownguide.org/basic-syntax/),通过 Markdown 官网，读者可以了解 Markdown 的全部语法，虽然说是全部，但实际上也非常简单，基本上两三次之后就可以熟练使用。推荐 Typora或者 Obsidian。
...
[推荐硕哥的机器人工程师学习计划 ](https://zhuanlan.zhihu.com/p/22266788)对于机器人学习讲得非常好，整体偏向软件，因此很适合视觉/算法组的同学参考。
...
[参考 你缺失的那门计算机课 ](https://www.criwits.top/missing/)可以进行一些基础知识的扫盲，其中的前几个篇章都很有阅读的必要，不是对自己电脑的基本功绝对自信，也同样建议扫一遍目录，学习一下基础使用。

[计算机速成课 ](https://www.bilibili.com/video/BV1EW411u7th/?vd_source=5dedb30d6360efbc60e09176831af1d3)：百万播放量的超人气课程，深入浅出短小精悍入门必看。
[模拟电路和数字电路速成 ](https://www.bilibili.com/video/BV1774114798/?spm_id_from=333.788.recommend_more_video.0&vd_source=ddae2b7332590050afe28928f52f0bda)：着重关注晶体管与逻辑门、数字逻辑电路层面的知识，对于进一步学习很有帮助。
[学院派的计算机科学导论 ](https://www.bilibili.com/video/BV1Rb411378V/?vd_source=ddae2b7332590050afe28928f52f0bda)：广为流传的课程。
...
[廖雪峰Python教程（文档） ](https://liaoxuefeng.com/books/python/introduction/index.html)，
[小鱼视频 ](https://www.bilibili.com/video/BV1c4411e77t/?share_source=copy_web&vd_source=1b168096ad049545241f8cc47bbcded6)，
...
[OpenMV ](https://book.openmv.cc/index.html)：基于 STM32F7/H7 系列、刷入 OpenMV 固件的嵌入式视觉模块。体积小、重量轻，使用 MicroPython 开发，上手快。适合飞镖系统等需要同时兼顾视觉和运动控制的场景，也可为机器人提供辅助视觉功能，但 32 位处理器算力有限，不适合复杂视觉任务。
...
想要安装Ubuntu，可以参阅这篇教程：[Ubuntu/Windows双系统的安装 ](https://blog.csdn.net/NeoZng/article/details/122779035)，当然，学习时使用虚拟机也是不错的选择，这能给你更大的试错空间，不用担心把系统搞奔溃。---建议多方收集资料在开始，比如去B站找一些资料看看流程，明确了再开始安装，建议有电脑基础再安装。

我是用软件 [Ventoy ](https://www.ventoy.net/cn/index.html)作为启动盘，下载[Ubuntu22.04镜像 ](https://mirrors.tuna.tsinghua.edu.cn/ubuntu-releases/22.04.4/ubuntu-22.04.4-desktop-amd64.iso),具体不过多赘述。
...
[给傻子的Git教程-哔哩哔哩 ](https://b23.tv/J9WbYU0)
...
[全网最简单！三小时搞懂【卡尔曼滤波】原理及代码实战 ](https://b23.tv/fjtv2KL)

[卡尔曼滤波器 ](https://zhuanlan.zhihu.com/p/42390886)
...
在此网站：[A visual proof that neural nets can compute any function ](https://github.com/jerryjee120/Neural-Network)，有对神经网络是如何拟合出任意函数的形象的、直观的解释
...
**正则化：** Dropout 正则化（随机丢弃），训练时随机让部分神经元失活，防止模型过度依赖某些特征。

**数据增强：** 以图像分类为例，通过将训练集中的图像进行翻转、反转、裁切、旋转、变形和添加色彩偏差等方法来扩充数据集，是最廉价最简单的防止 overfit 的方法。虽然其效果不如收集更多的图片来得好，可架不住成本低、几乎无开销的特点。在小规模训练集上，数据增强是最有效的方法之一。

**Early Stopping（早停法）：** 如果训练轮数过多导致模型过拟合了训练数据，那就减少训练轮数。在训练集上过度优化会导致过拟合，适时停止训练是简单有效的方法。

### 其他
[行为树学习 ](https://www.behaviortree.dev/docs/intro/)（吴恩达）
...
[SLAM框架 ](https://www.bilibili.com/video/BV1hh4y187Da?vd_source=5dedb30d6360efbc60e09176831af1d3)

[局部路径规划 ](https://www.cmu-exploration.com/)

[常用的全流程导航框架 ](https://github.com/ros-navigation/navigation2)

[Nav2 — Nav2 1.0.0 文档 ](https://docs.nav2.org/)
...
[OpenCV相机标定完全指南 ](https://blog.csdn.net/NeoZng/article/details/122736567)
...
[html ](https://www.bilibili.com/video/BV1aE411i7Vg/?from=search&seid=5808431675478311012&vd_source=5dedb30d6360efbc60e09176831af1d3)，[css3 ](https://www.bilibili.com/video/BV1eE411p7tZ/?from=search&seid=5808431675478311012&vd_source=ddae2b7332590050afe28928f52f0bda)，[javascript ](https://www.bilibili.com/video/BV1nJ41127Dc/?from=search&seid=5808431675478311012&vd_source=ddae2b7332590050afe28928f52f0bda)：前端学习
...
[Wolfram|Alpha ](https://www.wolframalpha.com/): Computational Intelligence，有可能用得上的all-in-one智能搜索引擎

[SimpleTex - Snip & Get! ](https://simpletex.cn/ai/latex_ocr)，公式ocr识别，好用，准，免费

[Kaggle ](https://www.kaggle.com/)：比赛
